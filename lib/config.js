...
export const config = {
  ...
  passwordResetEmailFrom: getEnv('PASSWORD_RESET_EMAIL_FROM'),
  passwordResetTtlMinutes: Number.parseInt(getEnv('PASSWORD_RESET_TTL_MINUTES', '30'), 10),
  passwordResetCooldownSeconds: Number.parseInt(getEnv('PASSWORD_RESET_COOLDOWN_SECONDS', '60'), 10),
  sessionTtlHours: Number.parseInt(getEnv('SESSION_TTL_HOURS', '12'), 10)
};
